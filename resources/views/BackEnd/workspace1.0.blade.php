...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Responsive Table | Skote - Responsive Bootstrap 4 Admin Dashboard</title>
        ...
        <link href="{{url('theme').'/assets/libs/admin-resources/rwd-table/rwd-table.min.css'}}" rel="stylesheet" type="text/css" />
    ...
    <body data-topbar="dark" data-layout="horizontal">
        ...
        <!-- Init js -->
        <script src="{{url('theme').'/assets/js/pages/table-responsive.init.js'}}"></script>
