                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Dashboardqqq</h4>
                                    ...
                                    <div class="bg-soft-primary">
                                        <div class="row">
                                            ...
                                            <div class="col-5 align-self-end">
                                                <img src="{{url('theme').'/assets/images/profile-img.png'}}" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="avatar-md profile-user-wid mb-4">
                                                    <img src="{{url('theme').'/assets/images/users/avatar-1.jpg'}}" alt="" class="img-thumbnail rounded-circle">
                                                </div>
                                    ...
                                    <table class="table table-centered table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <div>
                                                        <img src="{{url('theme').'/assets/images/product/img-7.png'}}" alt="" class="avatar-sm">
                                                    </div>
                                                </th>
                                                <td>
                                                    <div>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div>
                                                        <img src="{{url('theme').'/assets/images/product/img-4.png'}}" alt="" class="avatar-sm">
                                                    </div>
                                                </th>
                                                <td>
                                                    <div>
